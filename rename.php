...
foreach ($it as $path) {
    ...
    $file_contents = str_replace("authgenerator", $newname, $file_contents); // oldname, newname
    file_put_contents($path_to_file, $file_contents);
}

// file and folder rename procedure
rename("./lang/en/auth_authgenerator.php", "./lang/en/auth_" . $newname . ".php");
rename("../moodle-auth_authgenerator", "../" . $newname);
